...
render resolutions. An area target uses `shape: rectangle` with
`box: [x, y, w, h]` (top-left corner + normalized width/height) instead of
`target`, and is drawn as a red rectangle rather than a laser dot.
...
with a laser dot or red rectangle marking the anchor target.
...
```text
slide-08.png       clean
slide-08-A.png     cue on A
slide-08-B.png     cue on B
```
...
content. A single laser dot or red rectangle is enough to answer “where should I look?”
